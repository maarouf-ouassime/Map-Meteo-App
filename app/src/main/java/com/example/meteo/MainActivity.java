...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgview.setImageResource(R.drawable.ic_baseline_filter_drama_24);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            System.out.println(coord.getDouble("lon"));
                            System.out.println(coord.getDouble("lat"));
    ...
    public void initialiserMap(){
        ...
        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(lat, lon), 6));
    }
